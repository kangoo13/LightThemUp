...
import kilomat.keylit.adapter.ListAdapterPlaylistSongAdd;
import kilomat.keylit.controller.SessionManager;
import kilomat.keylit.model.SongData;


public class PlaylistSongAddFragment extends Fragment {
    ...
    public PlaylistSongAddFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        alertDialog.setTitle(getString(R.string.playlist_add_song));

        // Setting Dialog Message
        alertDialog.setMessage(getString(R.string.playlist_popup_playlist));


        // Setting OK Button
        alertDialog.setButton(getString(R.string.action_ok), new DialogInterface.OnClickListener() {
                            ...
                            public void onResponse(JSONObject response) {
                                {
                                    ...
                                    for (int i = 0; i < arrJson.length(); i++) {
                                        try {
                                            ...
                                            if (mSongsList != null) {
                                                mRecyclerView.setAdapter(new ListAdapterPlaylistSongAdd(getContext(), mSongsList,
