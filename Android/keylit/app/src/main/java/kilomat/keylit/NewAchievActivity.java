...
public class NewAchievActivity extends AppCompatActivity {
    /**
     * Used for logging purposes.
     */
    private static final String TAG = NewAchievActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(NewAchievActivity.this);
    ...
    private void fetchMovies() {
        Toast.makeText(NewAchievActivity.this, "Executing Task", Toast.LENGTH_SHORT).show();
